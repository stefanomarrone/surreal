...
public class ExecutionManager {
	...
	public ExecutionManager(String tlnm, String tfn, String rfn) {
	...
	public ExecutionManager(String tlnm, String tfn, String rfn, int bmclen) {
		this.temporaryFileName = tfn;
		this.toolname = tlnm;
		this.resultFileName = rfn;
		this.prefix = "";
	...
	public ExecutionManager() {
		this.temporaryFileName = "temp.smv";
		this.resultFileName = "temp.rslt";
		this.toolname = "NuSMV";
		this.prefix = "";
		this.pj = null;
		this.setPrefix();
