...
import org.surreal.samgen.modeloracle.UMLHelper;
...
public class SystemModelFactory {
	...
	public static SystemModel generate(UMLHandler o) {
	...
	private static SystemModel complete(SystemModel sm, Vector<misuseImpl> ms, Vector<recoveryImpl> rs, UMLHandler o) {
...
//				rr.addAttack(aa);
	...
	public static Recovery generateRecovery(UMLHandler o, recoveryImpl rc, Vector<Attack> aas) {
	...
	private static Hashtable<String, Vector<String>> getASMap(Vector<misuseImpl> misues, UMLHandler o) {
	...
	private static Hashtable<String, Vector<String>> getRAMap(Vector<recoveryImpl> recoveries, UMLHandler o) {
		Hashtable<String, Vector<String>> retval = new Hashtable<String, Vector<String>>(); 
