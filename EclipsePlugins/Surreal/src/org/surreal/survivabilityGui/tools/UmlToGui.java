...
public class UmlToGui {
   ...
   public static ArrayList<String> getTaggedValuesFromStereotype( Collection<NamedElement> namedElements, String stName, String tgName ) {
	...
	public static ArrayList<String> getSMDfromConstrains(ArrayList<String> serviceModes) {
		ArrayList<String> retval = new ArrayList<String>();
		for (String t: serviceModes) {
	...
	public static ArrayList<String> getServiceModes(Model umlModel) {
		Resource r = umlModel.eResource();
		...
		while ((retval == null) && (counter < list.size())) {
			it = list.get(counter);
			if (it instanceof ServiceModeDefinitionImpl) {
				ServiceModeDefinition smd = (ServiceModeDefinition) it;
				retval = new ArrayList<String>(smd.getFormula());
			}
			counter++;
		}
		if (retval != null) {
