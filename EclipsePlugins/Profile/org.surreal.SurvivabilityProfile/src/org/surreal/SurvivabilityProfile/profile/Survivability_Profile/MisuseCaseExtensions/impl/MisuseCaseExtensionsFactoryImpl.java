...
public class MisuseCaseExtensionsFactoryImpl extends EFactoryImpl implements MisuseCaseExtensionsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case MisuseCaseExtensionsPackage.SERVICE_MODE_CONTEXT: return createServiceModeContext();
			default:
	 ...
	 * @generated
	 */
	public ServiceModeContext createServiceModeContext() {
		ServiceModeContextImpl serviceModeContext = new ServiceModeContextImpl();
		return serviceModeContext;
	}
