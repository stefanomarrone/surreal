...
import org.surreal.SurvivabilityProfile.profile.Survivability_Profile.SurvivabilityModelExtensions.scenario;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.surreal.SurvivabilityProfile.profile.Survivability_Profile.SurvivabilityModelExtensions.impl.scenarioImpl#getBase_Transition <em>Base Transition</em>}</li>
 *   <li>{@link org.surreal.SurvivabilityProfile.profile.Survivability_Profile.SurvivabilityModelExtensions.impl.scenarioImpl#getPath <em>Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class scenarioImpl extends MinimalEObjectImpl.Container implements scenario {
	...
	public EList<serviceMS> getPath() {
		if (path == null) {
			path = new EObjectResolvingEList<serviceMS>(serviceMS.class, this, SurvivabilityModelExtensionsPackage.SCENARIO__PATH);
		}
		return path;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SurvivabilityModelExtensionsPackage.SCENARIO__PATH:
				return getPath();
		}
