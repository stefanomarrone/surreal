...
public class modeImpl extends MinimalEObjectImpl.Container implements mode {
	...
	protected EClass eStaticClass() {
		return SAMExtensionsPackage.Literals.MODE;
	}
		...
		if (base_State != null && base_State.eIsProxy()) {
			...
			if (base_State != oldBase_State) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SAMExtensionsPackage.MODE__BASE_STATE, oldBase_State, base_State));
			}
		}
		return base_State;
	}
	...
	public void setBase_State(State newBase_State) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SAMExtensionsPackage.MODE__BASE_STATE, oldBase_State, base_State));
	}
