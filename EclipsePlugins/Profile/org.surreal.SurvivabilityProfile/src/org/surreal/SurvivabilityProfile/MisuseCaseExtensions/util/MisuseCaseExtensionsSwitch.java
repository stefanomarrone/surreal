...
public class MisuseCaseExtensionsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MisuseCaseExtensionsPackage.SERVICE_MODE_DEFINITION: {
				ServiceModeDefinition serviceModeDefinition = (ServiceModeDefinition)theEObject;
				T result = caseServiceModeDefinition(serviceModeDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Service Mode Definition</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Service Mode Definition</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseServiceModeDefinition(ServiceModeDefinition object) {
		return null;
	}
